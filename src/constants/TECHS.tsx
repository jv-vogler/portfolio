...
const TECHS: Tech[] = [
  ...
  {
    id: 6,
    icon: <SiNextdotjs color="#999" size={SIZE} aria-hidden={true} />,
    title: 'Next.js',
    color: '#999',
  },
  {
    id: 7,
    icon: <SiNodedotjs color="#8bbf3d" size={SIZE} aria-hidden={true} />,
    title: 'Node.js',
    color: '#8bbf3d',
  },
  {
    id: 8,
    icon: <SiChakraui color="#68CACD" size={SIZE} aria-hidden={true} />,
    title: 'Chakra UI',
    color: '#68CACD',
  },
  {
  ...
  {
    id: 10,
    icon: <SiFirebase color="#ed7e0b" size={SIZE} aria-hidden={true} />,
    title: 'Firebase',
    color: '#ed7e0b',
  },
  {
